...
echo [3/6] Commit...
git commit -m "PrepaFlyPy 0.3.2 (carte de consultation, FR-EN, maj auto, logo, nettoyage) : coeur SORA/regimes/DJI, API, UI web, CLI, tests, CI"
...
echo [6/6] Tag de version v0.3.2 (declenche la construction des .exe)...
git tag v0.3.2
