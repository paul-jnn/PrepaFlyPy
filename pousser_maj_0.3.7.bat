...
echo [3/6] Commit...
git commit -m "PrepaFlyPy 0.3.7 : plan de vol interactif (dessin zone + marqueurs + mesure distance/surface) ; liste des contraintes IGN sous la carte ; exemples grises dans les champs ; dossier de vol PDF complet"
...
echo [6/6] Tag de version v0.3.7 (declenche la construction des .exe)...
git tag v0.3.7
...
echo   Quand la release v0.3.7 est prete, l'appli te proposera la MAJ.
echo ================================================================
pause
