...
echo [3/6] Commit...
git commit -m "PrepaFlyPy 0.3.3 (installateur Windows + raccourcis premier lancement) : coeur SORA/regimes/DJI, API, UI web, CLI, tests, CI"
...
echo [6/6] Tag de version v0.3.3 (declenche la construction des .exe)...
git tag v0.3.3
