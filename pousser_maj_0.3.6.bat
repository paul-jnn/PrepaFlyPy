...
echo [3/6] Commit...
git commit -m "PrepaFlyPy 0.3.6 : dossier de vol PDF complet (niveau officiel) ; plan de vol interactif (dessin zone + marqueurs + mesure distance/surface) ; liste des contraintes IGN sous la carte ; exemples grises dans les champs ; nouveaux champs appareil ; i18n FR/EN"
